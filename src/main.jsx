...
import CategoryPage from "./Pages/Home/Home/DisplayCategories/CategoryPage/CategoryPage.jsx";
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      },
      {
        ...
        loader: ({ params }) =>
          fetch(`https://poke-verse-server.vercel.app/products/${params.id}`),
      },
      {
