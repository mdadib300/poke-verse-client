  ...
  const handleAddProduct = async (e) => {
    ...
    if (imageFiles.length === 0) {
      Swal.fire({
        ...
        customClass: {
          confirmButton:
            "bg-neutral-900 hover:bg-neutral-800 text-white px-4 py-2 rounded",
        },
    ...
    const productInfo = {
      ...
      sizes,
      colors,
      orderType: form.orderType.value || "Available",
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-center p-5">
        ...
        >
          <label className="block text-sky-400 font-medium">
            Product Title
          </label>
          <input
            type="text"
          ...
          <label className="block text-sky-400 font-medium mt-3">
            Product Description
          </label>
          <textarea
            name="description"
          ...
          <label className="block text-sky-400 font-medium mt-3">
            Release Date (Applicable for Pre-Order)
          </label>

          <input
            type="date"
            name="releaseDate"
            className="input w-full rounded-lg border border-sky-300 bg-sky-50"
          />
