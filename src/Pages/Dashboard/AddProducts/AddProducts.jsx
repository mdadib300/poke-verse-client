            ...
            <div className="flex items-center justify-center p-5">
                <form onSubmit={handleAddProduct} className="space-y-4 flex flex-col justify-center">
                    ...
                    <input
                        ...
                        className="w-full rounded-lg border border-sky-300 bg-sky-50 text-sky-400 placeholder-sky-300 focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-400 p-3"
                    />
                    <label className="block text-sky-400 font-medium mt-3">Product Photo</label>
                    <input type="file" name="image" required className="file-input" />

                    <input className="w-full mt-4 px-4 py-2 rounded-lg border border-sky-400 bg-sky-100 text-sky-400 font-medium transition-all duration-200 hover:bg-sky-400 hover:text-white" type="submit" value="Add Product" />
                </form>
            </div>
        </div>
    );
